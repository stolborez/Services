...
namespace LoggingService.Controllers
{
    ...
    public class UserLogMessageController : ControllerBase
    {
        private readonly IRepository<LogMessage> _logMessageRepository = new MongoRepository<LogMessage>("UserLogMessage");
        private readonly ILogger<UserLogMessageController> _logger;
        /// <summary>
        /// 
        /// </summary>
        /// <param name="logger"></param>
        public UserLogMessageController(ILogger<UserLogMessageController> logger)
        {
            _logger = logger;
        }
